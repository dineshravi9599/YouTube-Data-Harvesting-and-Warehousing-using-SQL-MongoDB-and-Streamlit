...
def list_mongodb_collection_names(database):
    dinesh = pymongo.MongoClient("mongodb://localhost:27017/")
    db = dinesh[database]
...
def sql_create_tables():
    dinesh_sql = psycopg2.connect(host='localhost', user='postgres', password='test123', database='youtube')
    cursor = dinesh_sql.cursor()
...
def list_sql_channel_names():
    dinesh = psycopg2.connect(host='localhost', user='postgres', password='test123', database='youtube')
...
def sql_channel(database, col_input):
    dinesh_mdb = pymongo.MongoClient("mongodb://localhost:27017/")
    db = dinesh_mdb[database]
    col = db[col_input]
...
def channels_totalchannels():
    ...
    dinesh_s = psycopg2.connect(host='localhost', user='postgres', password='test123', database='youtube')
    cursor = dinesh_s.cursor()
